setwd('C:/Users/Priyank/OneDrive/Documents/MIS/Predictive Analysis/FogNets/DataSources')
...
#dim(Agadir.data.full)
#Agadir.T
#x <- ts(Agadir.data.full$Agadir.T)
#Agadir.data.full$Agadir.T.impute <- na.interpolation(x)
#x1 <- Agadir.data.full[,c('X','Agadir.T','Agadir.T.impute')]

#Agadir.P0
#x <- ts(Agadir.data.full$Agadir.P0)
#Agadir.data.full$Agadir.Po.impute <- na.interpolation(x)
#x2 <- Agadir.data.full[,c('X','Agadir.P0','Agadir.Po.impute')]

#Agadir.P
#x <- ts(Agadir.data.full$Agadir.P)
#Agadir.data.full$Agadir.P.impute <- na.interpolation(x)
#x3 <- Agadir.data.full[,c('X','Agadir.P','Agadir.P.impute')]

#Agadir.U
#x <- ts(Agadir.data.full$Agadir.U)
#Agadir.data.full$Agadir.U.impute <- na.interpolation(x)
#x4 <- Agadir.data.full[,c('X','Agadir.U','Agadir.U.impute')]


#Agadir.DD
#x <- ts(Agadir.data.full$Agadir.DD)
#Agadir.data.full$Agadir.DD.impute <- na.interpolation(x)
#x5 <- Agadir.data.full[,c('X','Agadir.DD','Agadir.DD.impute')]


#Agadir.DD
#x <- ts(Agadir.data.full$Agadir.WW)
#Agadir.data.full$Agadir.WW.impute <- na.interpolation(x)
#x6 <- Agadir.data.full[,c('X','Agadir.WW','Agadir.WW.impute')]
