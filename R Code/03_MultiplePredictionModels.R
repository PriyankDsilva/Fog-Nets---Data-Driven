...
colnames(training.data.PlusSidi)
...
colnames(training.data.PlusGuelmim)
#Training data
...
colnames(training.data.PlusAgadir)
...
colnames(training.data.PlusNearby)
...
colnames(training.data.PlusAll)
...
#crete H2O model
H2ODeepLearning <- h2o.deeplearning(x = c(1,3:51), y = 52 ,  training_frame = training.data.hex,
